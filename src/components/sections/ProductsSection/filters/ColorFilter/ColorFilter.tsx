              ...
              return (
                <div key={i} className={styles.colorItem}>
                  <div className={styles.skeletonColorRow}>
                    <Skeleton className={styles.skeletonColorSwatch} />
                    <Skeleton className={
                      widths[i] === 120 ? styles.skeletonColorName120 :
                      widths[i] === 110 ? styles.skeletonColorName110 :
                      styles.skeletonColorName100
                    } />
                  </div>
                  <Skeleton className={styles.skeletonColorCount} />
                </div>
              );
            })}
          </div>
