...
/* icon-14.svg: зовнішній контур (заповнена зірка) і повний path (порожня з обводкою) */
...
const StarIcon = ({ filled }: { filled: boolean }) => (
  ...
  >
    {filled ? (
      ...
      <path d={starPathEmpty} fill="transparent" fillRule="evenodd" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
    )}
  </svg>
);
